var OtherPlayers = function(socket, playerCollection) {
	var t = this;
	t.socket = socket;
	t.players = playerCollection;
...
p.handleNewPlayer = function(data) {
	...
	this.players.addPlayer( new Player(false, data.id, data.r, data.g, data.b, data.x, data.y) );
};
