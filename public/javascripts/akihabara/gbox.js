...
var gbox={
  ...
  */    
//TODO TODO TODO !T!O!D!O!  pt in that if '(this._objects[group]){...} which might not work in the future' - Sashman
  ...
  */
	loadAll:function(cb) {
		...
		// Default stuff
		this.addImage("_dbf",akihabara_dir+"akihabara/debugfont.png");
